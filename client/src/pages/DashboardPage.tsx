  ...
  return (
    <div className="space-y-16">
      ...
      <section className="max-w-[800px]">
        ...
        <h1 className="text-[38px] md:text-[48px] font-black text-ink leading-tight mb-5 whitespace-nowrap overflow-x-auto">
          主厨，今天想创造什么新味道？
        </h1>
        <p className="text-[18px] font-bold text-ink-light whitespace-nowrap overflow-x-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <button
          ...
          className="paper-card p-8 border border-paper-stone/60 bg-paper text-ink active:scale-[0.98] transition-all text-left hover:border-sage/30"
        >
          <div className="h-12 w-12 rounded-2xl bg-paper-light flex items-center justify-center text-sage mb-6">
            <Timer className="h-6 w-6" />
          </div>
          <h3 className="text-[14px] font-black text-ink-light uppercase tracking-widest mb-2">点菜</h3>
          <p className="text-[32px] font-black leading-tight text-ink">
